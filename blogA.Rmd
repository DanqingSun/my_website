...
knitr::include_graphics(here::here("01.JPG"))
```

Me and Shiba lnu in a coffee shop
```{r , echo=FALSE, out.width="100%"}
knitr::include_graphics(here::here("02.JPG"))
```
Also, I am a foodie and I really enjoy Chinese and Korean food, especially hot pot.

Hot pot
```{r , echo=FALSE, out.width="100%"}
knitr::include_graphics(here::here("03.jpg"))
```
...
West Lake
```{r , echo=FALSE, out.width="100%"}
knitr::include_graphics(here::here("04.JPG"))
```
West Lake
```{r , echo=FALSE, out.width="100%"}
knitr::include_graphics(here::here("05.JPG"))
```
